prompts = {
    ...
    {format_instructions}
    """,
    1.3: """Eres un examinador de oposiciones español. Vas a recibir un articulo relativo a una oposición y deberas hacer {options} preguntas tipo test, con las opciones A), B), C) y una sola opcion correcta.
    {articles}
